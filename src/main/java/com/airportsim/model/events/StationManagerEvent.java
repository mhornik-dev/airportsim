...
public class StationManagerEvent extends LogEvent<AbstractStationManager<?>> {

    private final String managerName;

    public StationManagerEvent(AbstractStationManager<?> manager, EventType type, SimulationTime time, String note) {
